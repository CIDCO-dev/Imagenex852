...
#include "../Dump852/workerThread.h"
...
QT_MOC_LITERAL(1, 13, 17), // "AccessFileChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 22) // "ProgressVisibleChanged"

    },
    "WorkerThread\0AccessFileChanged\0\0"
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WorkerThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::AccessFileChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WorkerThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::ProgressVisibleChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::AccessFileChanged(bool _t1)
{
...
// SIGNAL 1
void WorkerThread::ProgressVisibleChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
